...
@endif
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <h1 class="text-3xl font-medium text-black">About Me</h1>
                                    ...
                                    <thead>
                                        <tr >
                                            <th
                                                ...
                                                No</th>
                                            <th
                                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-center text-white uppercase border-b border-gray-200 bg-gray-900">
                                                About</th>
                                            {{-- <th
                                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-white uppercase border-b border-gray-200 bg-gray-900">
                                                Email</th>
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-no-wrap border-b border-black text-center">{{ $data->about }}</td>
              <td class="px-6 py-4 whitespace-no-wrap border-b border-black">
                  <div class="flex flex-wrap gap-2 px-3 justify-center">
                <a href="{{ url('about/update/'.$data->id) }}" class="bg-green-500 text-white p-2 rounded" >Update</a>
                </div>
              </td>
            </tr>
            @endforeach
