...
@endif
				...
				<input type="text" id="table-search" name="cari" value="{{$request->cari}}" class="bg-white border border-gray-300 text-black text-sm rounded-lg block w-50 pl-10 p-2.5" placeholder="Search for items">
            ...
            @endforeach
                        ...
                        <a class="w-12 p-2 bg-yellow-500" href="{{ url('/admin') }}">Back</a>
                    </div>
                </div>
            </main>
  </div>
